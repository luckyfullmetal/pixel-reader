...
def process_video(file_path):
    ...
    # Fast 8-byte direct layout header
    ...
    print(f"Generated binary stream {output_filename} ({frame_count} frames) at {TARGET_WIDTH}x{TARGET_HEIGHT}!")
